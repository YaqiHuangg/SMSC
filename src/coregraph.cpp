...
void coregraph::setLeaves(vector<vector<pair<pair<unsigned int, unsigned int>, vector<int>>>> newleaves)
{
	leaves = newleaves;
}
...
void coregraph::leaveScan()
{
	leaves = vector<vector<pair<pair<unsigned int, unsigned int>, vector<int>>>> (num_vertices);
}
